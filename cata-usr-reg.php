...
if($_POST)
{
    $res = $clSistema -> registrarUsuario();
    if($res)
    {
        ?>
            <div class="alert alert-success" role="alert">
                El usuario se guard&oacute; correctamente!
            </div>
<script>
setTimeout(function(){
    window.location="?tCodSeccion=cata-usr-sis";
},2500);
</script>
<?
    }
                                        ...
                                        <div class="form-group">
											...
											<option value="">Seleccione</option>
												...
												$select = "SELECT * FROM SisPerfiles".
															($_SESSION['sessionAdmin'][0]['bAll'] ? "" : " WHERE eCodPerfil > 1").
